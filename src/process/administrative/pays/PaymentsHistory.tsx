                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-baseline gap-2">
                        <p className="text-2xl font-bold">{stats && formatCurrency(stats.monthly_income)}</p>
                        {stats && stats.monthly_variation !== null && (
                          <span className={`text-xs font-semibold px-1.5 py-0.5 rounded ${stats.monthly_variation >= 0 ? 'bg-green-500/10 text-green-700 dark:text-green-400' : 'bg-red-500/10 text-red-700 dark:text-red-400'}`}>
